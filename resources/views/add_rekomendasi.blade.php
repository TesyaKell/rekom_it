...
{{-- <div class="form-group">
    <label for="masukkan" class="mb-1">Tambahan</label>
    <input class="form-control" id="masukkan" name="masukkan" placeholder="Masukkan Tambahan">
</div>
<div class="form-group mt-2">
    <label for="hargaakhir" class="mb-1">Harga Akhir (Rp)</label>
    <input class="form-control" id="hargaakhir" name="harga_akhir" placeholder="Rp.">
</div> --}}
